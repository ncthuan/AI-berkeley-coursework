...
class ExactInference(InferenceModule):
    ...
    def observe(self, observation, gameState):
        ...
        # handle the "jail" edge case where the ghost is eaten and noisyDistance is None
    ...
    def elapseTime(self, gameState):
        ...
        *** GORY DETAIL AHEAD ***
        ...
        for pos in self.legalPositions:
            newPosDistribution = self.getPositionDistribution(self.setGhostPosition(gameState, pos))
            # update prob of ghost at newPos position 
            for newPos, prob in newPosDistribution.items():
                allPossible[newPos] += prob * self.beliefs[pos]
